...
const (
	VideoProcessingService_ProcessNewVideoRequest_FullMethodName = "/salonbe.VideoProcessingService/ProcessNewVideoRequest"
)
...
var VideoProcessingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "salonbe.VideoProcessingService",
